...
Refer - [block-device--disk--partition--filesystem--mounting-overview.md](block-device--disk--partition--filesystem--mounting-overview.md#when-using-logical-volumes-httpswwwyoutubecomlives5jgw4en5mesi_vl99ublbprfmcbo)
